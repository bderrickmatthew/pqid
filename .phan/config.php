...
use Phan\Issue; // Ensure this is correct and the Phan library is installed
...
return [
    ...
    'minimum_severity' => Issue::SEVERITY_LOW, // Add the fully qualified namespace if necessary
    ...
    'directory_list' => [
        'vendor/bramus/router/src',
        'vendor/catfan/medoo/src',
        'vendor/phpunit/phpunit/src',
        'vendor/symfony/var-dumper',
        'vendor/vlucas/phpdotenv/src',
        'public/',           // Add your project directories
        'templates/',
        '.ignore/'
    ],

    // A list of individual files to include in analysis
    // with a path relative to the root directory of the    // project.
    'file_list' => [],
];